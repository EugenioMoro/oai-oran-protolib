...
_RAN_PARAMETER = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='IQ_MAPPING', index=7, number=8,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INCUMBENT_ACTION', index=8, number=9,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
